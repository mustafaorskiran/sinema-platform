...
const MOODS = [
  {
    id: 'mutlu',
    emoji: '😄',
    label: 'Neşeli & Eğlenceli',
    desc: 'Güldüren, hafif, iyi hissettiren',
    color: '#facc15',
  ...
  },
  {
    id: 'heyecan',
    emoji: '⚡',
    label: 'Heyecan & Aksiyon',
    desc: 'Tempolu, aksiyonlu, sürükleyici',
    color: '#f87171',
  ...
  },
  {
    id: 'dusunceli',
    emoji: '🤔',
    label: 'Derin & Düşündürücü',
    desc: 'Ağır, felsefi, zihinsel yolculuk',
    color: '#a78bfa',
  ...
  },
  {
    ...
    emoji: '💕',
    label: 'Romantik',
    desc: 'Aşk, his, duygusal yolculuk',
    color: '#fb7185',
  ...
  },
  {
    ...
    emoji: '👻',
    label: 'Ürkütücü',
    desc: 'Korku, gerilim, yapayalnız hisset',
    color: '#4ade80',
  ...
  },
  {
    ...
    emoji: '🗺️',
    label: 'Macera & Keşif',
    desc: 'Yeni dünyalar, epik yolculuklar',
    color: '#60a5fa',
  ...
  },
  {
    ...
    emoji: '🎙️',
    label: 'Gerçek Hayat',
    desc: 'Belgesel, biyografi, gerçek olaylar',
    color: '#fb923c',
  ...
  },
  {
    ...
    emoji: '👨‍👩‍👧',
    label: 'Aile ile',
    desc: 'Her yaşa uygun, birlikte izle',
    color: '#34d399',
  ...
  },
  {
    ...
    emoji: '🌙',
    label: 'Gece Geç Saat',
    desc: 'Gerilim, suç, noir, karanlık',
    color: '#c4b5fd',
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-3xl font-black text-white mb-2">Bugün Nasıl Hissediyorsun?</h1>
        <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>
          Ruh haline göre en uygun film ve diziyi bul
        </p>
      </div>
          ...
          <div key={mood.id} className="rounded-2xl p-5 transition-all duration-200 hover:-translate-y-0.5"
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: 'rgba(255,255,255,0.4)' }}>{mood.desc}</p>
              </div>
            </div>
