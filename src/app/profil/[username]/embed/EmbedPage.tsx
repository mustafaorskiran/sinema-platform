    ...
    <div className="max-w-2xl mx-auto px-4 py-12">
      <div className="mb-8">
        <h1 className="text-2xl font-black text-white mb-1">
          {isOwn ? 'Widget — Sitene Ekle' : `@${username} Widget`}
        </h1>
        <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>
          {isOwn
            ? 'Bu widget\'ı blogun veya web sitene ekleyerek Sinezon profilini paylaş.'
            : `@${username} kullanıcısının Sinezon widget'ı`}
        </p>
      </div>
      ...
      <div className="rounded-2xl p-5 mb-6"
        ...
        <p className="text-xs font-semibold uppercase tracking-widest mb-4" style={{ color: 'rgba(255,255,255,0.3)' }}>Ayarlar</p>
        <div className="flex items-center gap-4">
          <label className="text-sm text-white">Son izlenenler:</label>
      ...
      <div className="rounded-2xl overflow-hidden"
        ...
        <div className="flex items-center justify-between px-4 py-3" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>HTML Kodu</p>
          <button onClick={copy}
      ...
      <p className="text-[11px] text-center mt-4" style={{ color: 'rgba(255,255,255,0.2)' }}>
        Widget her 10 dakikada bir güncellenir · Tüm veriler Sinezon'dan çekilir
      </p>
    </div>
  )
}
