      ...
      {currentUserId ? (
        <form onSubmit={submitComment} className="flex gap-3">
          <textarea
            ...
            rows={2}
            maxLength={1000}
            className="flex-1 rounded-xl bg-[--bg-card] border border-[--border] px-4 py-2.5 text-sm text-white placeholder-[--text-secondary] outline-none focus:border-[--accent] transition-colors resize-none"
          />
